...
model = pickle.load(open(r'C:\Users\asouk\Desktop\salary_prediction-main\model.pkl','rb'))
model_columns=pickle.load(open(r'C:\Users\asouk\Desktop\salary_prediction-main\model_columns.pkl','rb'))
